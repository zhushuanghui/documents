...
import {Form, Button, Input, Select, Table, Pagination, Dialog} from 'element-react';
import {formatDate, formatData,lableWidth} from "./common/common";
            ...
            <div className="container">
                ...
                <Dialog
                    ...
                    <Dialog.Footer className="dialog-footer">
                        <Button
                            onClick={() => this.onCancel(this.refs.addForm,'dialogAdd')}>取 消</Button>
                ...
                <Dialog
                    ...
                    onCancel={() =>  this.onCancel(this.refs.editForm,'dialogEdit')}>
                    <Dialog.Body>
                        <Form ref="editForm"
