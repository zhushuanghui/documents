...
class App extends Component {
    ...
    componentWillMount() {
        this.setState({'loginName': localStorage.getItem('loginName'), role: localStorage.getItem('role')});
    }


    render() {
        let role = this.state.role;
       let style=role === "2" ? {display: "block"} : {display: "none"};
       let style1=role === "1" ? {display: "block"} : {display: "none"};
        return (
            <div className="app">
                ...
                <div className="page">
                    <div className="nav" style={{textAlign: "center"}}>
                        <NavLink to={"/channel"} style={style}>
                        ...
                        <NavLink to={"/productdown"} style={style1}>
                            <div className="row">产品列表</div>
                        </NavLink>
                        <NavLink to={"/admin"}
                                 style={style}>
                        ...
                        <NavLink to={"/daylist"} style={style}>
                            <div className="row">每日统计</div>
                        </NavLink>
                        <NavLink to={"/daylistdown"} style={style1}>
                            <div className="row">每日统计</div>
                        </NavLink>
