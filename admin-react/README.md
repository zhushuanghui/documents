...
<input placeholder="请选择" name="name" readonly="" type="text" class="el-input__inner" autocomplete="off" value="暂停">


<input placeholder="请选择" name="name" type="text" class="el-input__inner" autocomplete="off" value="暂停" readonly="">